...
$createroom = mysqli_query($mysql, "INSERT INTO room (roomowner, roomname, roompassword, hidden) VALUES (".$log_userid.",'".$post_roomname."','".$hash."',".$post_hidden.")");
if($createroom){
	$lastid = mysqli_insert_id($mysql);
	mysqli_query($mysql, "INSERT INTO chat (roomid, userid, message) VALUES (".$lastid.",0,'".$log_screen." created the room.')");
	echo $lastid;
	die();
} else {
